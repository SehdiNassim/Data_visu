...
with dataExploration:
    try:
        ...
        ax2.pie(newdf2[current_column2].value_counts().values,labels=newdf2[current_column2].value_counts().index)
        col2.pyplot(fig2)
        ...
        st.write('Veuillez choisir vos parametres:')
        col1, col2 = st.columns(2)
        ...
        if dummification: df = pd.get_dummies(df)
